...
// Beverage Training Endpoints (temporarily simplified)
app.get('/beverages', (c) => {
  return c.json({
    message: 'Beverage training available in main quiz sections',
    beverageSections: [
      'wine-sommelier-fundamentals',
      'beer-cicerone-fundamentals', 
      'whiskey-specialist',
      'tequila-specialist',
      'rum-specialist',
      'beverage-service'
